              ...
              <div className={styles.productDetailsWrapper}>
                ...
                <div className={styles.pdLayout}>
                  ...
                  <div className={styles.pdRightCol}>
                    ...
                    <div className={styles.pdInfoCard}>
                      <h3>Product Details</h3>
                      <div className={styles.pdInfoGrid}>
                        <div className={styles.pdInfoRow}><span>Format</span><span>PDF</span></div>
                        <div className={styles.pdInfoRow}><span>Pages</span><span>65</span></div>
                        <div className={styles.pdInfoRow}><span>Language</span><span>English</span></div>
                        <div className={styles.pdInfoRow}><span>Access</span><span>Instant Download</span></div>
                        <div className={styles.pdInfoRow}><span>License</span><span>Personal Use</span></div>
                        <div className={styles.pdInfoRow}><span>Updates</span><span>Lifetime Access</span></div>
                        <div className={styles.pdInfoRow}><span>Compatibility</span><span>Desktop, Tablet, Mobile</span></div>
                      </div>
                    </div>

                    <div className={styles.pdSupportCard}>
                      <h4>Need Help?</h4>
                      <p>Our support team is here whenever you need assistance.</p>
                      <button className={styles.pdSupportBtn}>Contact Support →</button>
                    </div>
                  </div>
                </div>

                <div className={styles.pdBottomSection}>
                  <h2 className={styles.pdBottomTitle}>What You&apos;ll Learn</h2>
                  <div className={styles.pdLearnGrid}>
                    <div className={styles.pdLearnItem}>
                ...
                <div className={styles.pdBenefitsBar}>
                  <div className={styles.pdBenefit}>
                  ...
                  <div className={styles.pdBenefit}>
                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M2 12a10 10 0 1 0 20 0 10 10 0 1 0-20 0M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18ZM12 7v5l3 3"/></svg>

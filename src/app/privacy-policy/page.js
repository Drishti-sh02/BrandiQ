      ...
      <div style={{
        ...
        <div style={{ lineHeight: '1.8', fontSize: '1.6rem', color: '#111' }}>
          ...
          <ul style={{ paddingLeft: '2rem', listStyleType: 'disc', margin: 0 }}>
            <li style={{ marginBottom: '1rem' }}>Your privacy is critically important to us. It is BrandiQ's policy to respect your privacy regarding any information we may collect from you across our website and other sites we own and operate.</li>

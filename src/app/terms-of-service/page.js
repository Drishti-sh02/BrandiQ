      ...
      <div style={{
        ...
        <div style={{ lineHeight: '1.8', fontSize: '1.6rem', color: '#111' }}>
          ...
          <ul style={{ paddingLeft: '2rem', listStyleType: 'disc', margin: 0 }}>
            ...
            <li style={{ marginBottom: '1rem' }}>Permission is granted to temporarily download one copy of the materials (information or software) on BrandeQ's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not modify or copy the materials.</li>
            <li style={{ marginBottom: '1rem' }}>The materials on BrandeQ's website are provided on an 'as is' basis. BrandeQ makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.</li>
            <li style={{ marginBottom: '1rem' }}>In no event shall BrandeQ or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on BrandeQ's website, even if BrandeQ or a BrandeQ authorized representative has been notified orally or in writing of the possibility of such damage.</li>
